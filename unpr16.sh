...
TARGET_PATH="/var/www/pterodactyl/resources/views/layouts/admin.blade.php"

echo "🔄 Menjalankan Uninstall Protect Menghilangkan Semua Menu..."
...
if [ -n "$LATEST_BACKUP" ] && [ -f "$LATEST_BACKUP" ]; then
    ...
    echo "💡 Hubungkan ulang file default jika diperlukan: "
    echo "   curl -sS https://raw.githubusercontent.com/pterodactyl/panel/v1.11.5/resources/views/layouts/admin.blade.php -o $TARGET_PATH"
    exit 1
fi
